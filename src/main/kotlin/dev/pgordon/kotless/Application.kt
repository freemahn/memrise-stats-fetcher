...
open class Pages {
    ...
    fun main(): ApiResponse {
        ...
        headers.set(
            //due to https://github.com/JetBrains/kotless/issues/7 kotless doesnt support env variables, so
            "cookie",   "ajs_anonymous_id=%22559b1057-2b40-4b94-9ef7-3e08a74dc692%22; __stripe_mid=3e3409dd-9ff6-4210-9278-a9ece77e9e4fcaac94; G_ENABLED_IDPS=google; G_AUTHUSER_H=0; sessionid_2=6b56hdk6dd0vf6lvhrrixexnaevm6nuz8; i18next=en; ajs_user_id=9898442; cookieconsent_status=allow; memrise_lang=en; csrftoken=Ndgq3Kfc0GscZh12NE9DThTcExXPkbIWHWOB1wx2ByryqaGF7kAMxXwIIRgzL8y3"
